...
import { FlaskConical, Loader2, SendHorizonal, ShieldOff } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-5 p-6">
      <PageHeader
        ...
        description="Send a real chat completion through a gateway to verify an AI backend end-to-end"
      />
